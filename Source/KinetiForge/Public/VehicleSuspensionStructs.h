...
struct KINETIFORGE_API FVehicleSuspensionKinematicsConfig
{
	...
	*/
	...
	/**
	* The location of the top mount relative to the pivot of the arm. 
	* It is under the coordinate of the wheel component, not car body.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FVector3f TopMountPosition = FVector3f(0.f, 45.f, 35.f);

	/**
	* Unit: cm. The traveling distance of the strut
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (ClampMin = "0.0"))
	float Stroke = 20.f;

	/**
	* Unit: cm. The length of the strut when the suspension is fully compressed.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (ClampMin = "0.0"))
	float MinStrutLength = 30.f;

	/**
	* Unit: cm. The length of the control arm.
	* 
	* For straight suspension, this will affect track width. But it will not affect suspension kinematics.
	* For double-wish-bone suspension, this can be considered as average arm length of all arms (maybe).
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (ClampMin = "0.0"))
	float ArmLength = 50.f;

	/**
	* The distance of the wheel hub(where the wheel is mounted) to the wheel knuckle(where the arm and wheel-hub/strut is connected).
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float AxialHubOffset = 5.f;

	/**
	* The angular offset of the wheel spinning axis.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
